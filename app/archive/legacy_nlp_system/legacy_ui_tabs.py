"""
ARCHIVED — UI legacy de flashcards / NLP / SM-2.

No montada en build_ui(). Conservada para Fase 4 (remediacion pedagogica).
Imports apuntan al paquete archive + servicios activos (db_manager, content_service).
"""
...
def _require_usuario_id() -> int:
    ...
    if usuario_id is None:
        raise RuntimeError("Sesion de usuario no inicializada.")
